...
interface LockedUser {
  ...
  manager: { username: string; lastNameFirstName: string | null } | null;
}
...
const columns: Column<LockedUser>[] = [
  ...
  },
  {
    key: "manager",
    label: "Manager",
    render: (u) => u.manager?.lastNameFirstName ?? u.manager?.username ?? "—",
  },
  {
    key: "hseBlocked",
    label: "Status",
...
export default function AdminLockoutPage() {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Users blocked due to failed HSE tests — {users.length} blocked
        </p>
      </div>
